...
do case "$i" in
       git-*) echo "Not copied" ;;
 toolchain-*) echo "Not copied" ;;
       linu*) echo "Not copied" ;;
      uclib*) echo "Not copied" ;;
       buil*) echo "Not copied" ;;
      host-*) echo "Not copied" ;;
     lib-ho*) echo "Not copied" ;;
        _us*) echo "Not copied" ;;
        lib*) echo "This is an added rule -- no lib-* " ;;
           *)
